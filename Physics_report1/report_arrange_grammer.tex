...
\begin{figure}[H]
    ...
    \end{minipage}
\end{figure}
今回の課題においては上下の$N_{\text{max}}$を測定しCの値を求めた。\\
...
これらの値どうしに幅がある理由としては以下のことが考えられる
\begin{enumerate}[label=\arabic*.]
...
また、e=3,W=4.5の光弾性画像とe=3,W=6.5の光弾性画像を比較するとe=3,W=6.5の条件においてより$N_{\text{max}}$の値が大きくなっていることがわかる。これは$N_{\text{max}}$の公式よりわかる。\\
