...
・S25CとS45Cの違い
  ...
  ・炭素を約0.25\%含む
  ・切削加工性・鍛造性・鋳型性が良い
  ・ボルト、ナット、ビスなどの大量生産部品に適している
   S45C
  ・炭素を約0.45\%含む
  ・強さと粘り強さをを重視する部品に使用する:車軸、クランク軸、など
・A5052とA2024の違い
   A5052
  ・固溶化処理・時効硬貨処理は基本的には不要
  ・冷間加工により強度を調整
   A2024
  ・時効硬化処理が必要
  ・焼入れ処理が重要
...
\begin{thebibliography}{99}
    \bibitem{guide} 京都大学工学部物理工学科, 『固体力学実験 指導書』, 2026.
    \bibitem{jsme} 日本機械学会 編, 『機械工学便覧』, 丸善出版, pp. 2-21, 5-14, 5-19--5-20, 5-60.
    \bibitem{jis_g} 日本産業規格, JIS G 4051:2016 「機械構造用炭素鋼鋼材」.
    \bibitem{jis_h} 日本産業規格, JIS H 4000:2014 「アルミニウム及びアルミニウム合金の板及び条」.
\end{thebibliography}
\end{document}